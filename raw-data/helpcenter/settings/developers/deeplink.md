...
### [hashtag](#what-is-deeplink) What is "Deeplink"?[**​**arrow-up-right](https://help.avada.app/joy/how-to-set-up-VIP-Tier/#introduction)
...
### [hashtag](#why-do-you-need-deeplinks) Why do you need Deeplinks?
...
### [hashtag](#how-to-trigger-widget-using-top-menu-only) How to trigger widget using top menu only

In **Widget Design** > **Advanced Settings**, simply toggle the **Hide Widget** option. This will hide the floating button, but the widget will still function and can be triggered via a deeplink or our [JS SDKarrow-up-right](https://devdocs.joy.so/joy-javascript-api/widget-methods#open-widget).
...
[PreviousMagic tagschevron-left](/settings/developers/magic-tags)[NextShopify Adminchevron-right](/shopify-admin)
