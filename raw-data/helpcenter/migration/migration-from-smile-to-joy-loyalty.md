...
- **Customer Status:** The customer's current status.
...
**Note**: If the customer list exported from the loyalty program managed by Smile is missing the VIP tier field, you can contact Smile's team for support in exporting the customer file with all necessary fields
...
Select `Migrate my loyalty program from: Smile.io`
...
[PreviousMigration from Stamped to Joy Loyaltychevron-left](/migration/migration-from-stamped-to-joy-loyalty)[NextMigration from Rivo to Joy Loyaltychevron-right](/migration/migration-from-rivo-to-joy-loyalty)
