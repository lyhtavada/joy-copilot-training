...
**Note**: If the customer list exported from the loyalty program managed by BON Loyalty is missing the VIP tier field, you can contact BON Loyalty's team for support in exporting the customer file with all necessary fields
...
Select `Migrate my loyalty program from:` BON Loyalty
...
Migrating from BON Loyalty to Joy Loyalty is a simple process that retains essential data. Following these steps will help you complete the migration without disruption to your loyalty program.

If you encounter any issues during the migration process, don't hesitate to contact our support team.

[PreviousMigration from Loyalty Lion to Joy Loyaltychevron-left](/migration/migration-from-loyalty-lion-to-joy-loyalty)[NextMigration from Yotpo Loyalty to Joy Loyaltychevron-right](/migration/migration-from-yotpo-loyalty-to-joy-loyalty)
