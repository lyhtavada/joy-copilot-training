...
- Advanced features such as Shopify customer tagging, Order tags,... are available for **Professional, Advanced** and **Enterprise** plans

### [hashtag](#what-is-referrals-feature) What is "Referrals" feature?
...
### [hashtag](#why-do-you-need-referrals-feature) Why do you need "Referrals" feature?
...
### [hashtag](#how-to-set-up-referrals-feature) How to set up "Referrals" feature?
...
Award fixed store credit amount

**Discount percentage**

Percentage off their first order (e.g., 10% off)
...
Award loyalty points per referral

**Store Credit (Fixed)**

Award fixed store credit per successful referral

**Store Credit (Order-based)**

Award store credit based on % of referee's order value
...
Enable the platforms where your customers can share their referral links
...
[PreviousRule Engine – Multiple Program Systemchevron-left](/reward-programs/rule-engine-multiple-program-system)[NextReferral flow explainedchevron-right](/reward-programs/referrals/referral-flow-explained)
