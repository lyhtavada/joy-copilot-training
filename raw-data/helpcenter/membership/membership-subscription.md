## [hashtag](#introduction-to-subscription-membership) Introduction to Subscription Membership
...
#### [hashtag](#why-use-subscription-membership) Why use Subscription Membership?
...
#### [hashtag](#common-use-cases) Common Use Cases

Here are the two most popular ways merchants use this feature:
...
#### [hashtag](#how-to-set-it-up) How to set it up
...
[👉 **Guide: Setup Subscription Membership with Joy Subscription**](/membership/membership-subscription/membership-subscription-via-joy-subscription)

**Option 2: Flexible Integration via Shopify Flow (Legacy) ⚙️**
...
[👉 **Guide: Setup Subscription Membership via Shopify Flow**](/membership/membership-subscription/membership-subscription-via-other-apps)

[PreviousTier Assessmentchevron-left](/membership/vip-tiers/tier-assessment)[NextMembership subscription (via Joy Subscription)chevron-right](/membership/membership-subscription/membership-subscription-via-joy-subscription)
