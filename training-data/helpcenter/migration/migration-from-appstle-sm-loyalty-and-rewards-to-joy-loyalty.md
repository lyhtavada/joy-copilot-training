---
category: Migration
topic: Migration From Appstle Sm Loyalty And Rewards To Joy Loyalty
source: helpcenter
---

Q: What is Migration From Appstle Sm Loyalty And Rewards To Joy Loyalty in Joy Loyalty?
Q: How does Migration From Appstle Sm Loyalty And Rewards To Joy Loyalty work?
Q: How do I migrate to Joy from Appstle Sm Loyalty And Rewards?
...
**Note**: If the customer list exported from the loyalty program managed by Appstle is missing the VIP tier field, you can contact Appstle's team for support in exporting the customer file with all necessary fields
...
Select `Migrate my loyalty program from:` Appstle℠ Loyalty & Rewards
...
Migrating from Appstle to Joy Loyalty is a simple process that retains essential data. Following these steps will help you complete the migration without disruption to your loyalty program.
