---
category: Migration
topic: Migration From Loyalty Lion To Joy Loyalty
source: helpcenter
---

Q: What is Migration From Loyalty Lion To Joy Loyalty in Joy Loyalty?
Q: How does Migration From Loyalty Lion To Joy Loyalty work?
Q: How do I migrate to Joy from Loyalty Lion?
...
**Note**: If the customer list exported from the loyalty program managed by Loyalty Lion is missing the VIP tier field, you can contact Loyalty Lion's team for support in exporting the customer file with all necessary fields
...
Select `Migrate my loyalty program from:` Loyalty Lion
...
Migrating from Loyalty Lion to Joy Loyalty is a simple process that retains essential data. Following these steps will help you complete the migration without disruption to your loyalty program.
