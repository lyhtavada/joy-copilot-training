---
category: Migration
topic: Migration From Yotpo Loyalty To Joy Loyalty
source: helpcenter
---

Q: What is Migration From Yotpo Loyalty To Joy Loyalty in Joy Loyalty?
Q: How does Migration From Yotpo Loyalty To Joy Loyalty work?
Q: How do I migrate to Joy from Yotpo Loyalty?
...
**Note**: If the customer list exported from the loyalty program managed by Yotpo Loyalty is missing the VIP tier field, you can contact Yotpo Loyalty's team for support in exporting the customer file with all necessary fields
...
Select `Migrate my loyalty program from:`Yotpo Loyalty
...
Migrating from Yotpo Loyalty to Joy Loyalty is a simple process that retains essential data. Following these steps will help you complete the migration without disruption to your loyalty program.
